...
DITS = [
    ("خمس أيام",            6.54,  11.10),
    ("٢٥ يوم",             13.26,  16.80),
    ("حبس ٣٠ يوم",         26.42,  30.48),
    ("traumatism",          45.84,  50.42),
    ("جيت هارب",           61.02,  66.86),
    ("كل ساعة",            89.24,  92.72),
    ("ناعس وكتدخل الفلوس", 99.58, 102.46),
    ("الباب",             115.68, 120.80),
    ("قواعد",             135.29, 138.00),
    ("ممارسات",           138.00, 140.30),
    ("قيم",               140.30, 142.02),
    ("خلصت الثمن غالي",   142.05, 150.45),
    ("السبع",             166.02, 172.92),
    ("الحبس ولا السبع",   177.96, 179.52),
]
